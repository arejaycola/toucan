...
const RetweetChart = () => {
	...
	return (
		<div style={{ textAlign: 'center' }}>
			<p>Retweet Chart</p>
			<D3RetweetChart id="d3-retweet-chart-day" tickFormat={dayTickFormat} dataVerified={verifiedDay} dataUnverified={unverifiedDay} />
			<D3RetweetChart id="d3-retweet-chart-hour" tickFormat={hourTickFormat} dataVerified={verifiedHour} dataUnverified={unverifiedHour} />
